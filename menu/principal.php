...
<html lang="en">
  <head>
    ...
    <link rel='shortcut icon' type='image/x-icon' href="../imagenes/ICO/logo_np_ico.ico"/>
	<link rel="stylesheet" type="text/css" href="../css/principal.css">


    <title>SISALMA-SIGESP</title>
...
-->
 ...
 <body oncontextmenu="return false"  onLoad="ini()" onkeypress="parar()" onclick="parar()">
    ...
    <nav class="navbar navbar-dark sticky-top navbar-expand-lg flex-md-nowrap p-0" > 
	 ...
	 <a id="a_titulo"  class="sombra_texto navbar-brand col-sm-6 col-md-2 mr-0" href="#"><b id="b_titulo">SISALMA-SIGESP</b>
	
	 <img class="contorno" id="img_logo" src="../imagenes/png/logo_np_marcadeagua.png" width="25px" /></a>
