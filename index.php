...
<html lang="en">
  <head>
    ...
    <link rel='shortcut icon' type='image/x-icon' href='imagenes/ICO/favicon.ico' />
	...
	<!-- FIM Bootstrap CSS -->
    <title>Acceso:: INTRA-BAHIA</title>
...
<body oncontextmenu="return false" id="body" background="imagenes/GIF/bodybkg_bahia.gif">
...
<div id="container" class="container">
	 ...
	 <div id="div_titulo" class="row justify-content-center border rounded">
		<h4 class="pt-3 pb-2"><strong>INTRANET - BAHIASUPERMARKET</strong></h4>
	 </div> 
	 <!--fin div_titulo -->
...
<!------------------------------------------------------------------------------------------ -->
				...
				<footer>
					<b id="pie">2023 - <?PHP echo $ano;?>, &copy; Elaborado por la <a href="mailto:walastre@hotmail.com"> Gerencia de Sistemas BahiaSupermarket </a></b>				
				</footer>	
  </div> <!--fin div_caja2 -->	 
</div>  <!--fin div_caja1 -->
